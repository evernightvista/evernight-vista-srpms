...
Patch1001:      plasmalogin-rpmostree-tmpfiles-hack.patch
...
Requires:      evernight-vista-logon-settings
Requires:      evernight-vista-themeui
Requires:      kmscon >= 9.3.1-1
...
Requires:      (evernight-vista-logon-kcm%{?_isa} if plasma-systemsettings%{?_isa})
...
%package -n evernight-vista-logon-kcm
Summary: KDE KCM for %{name}
Requires: %{name}%{?_isa} = %{version}-%{release}
Requires: dbus-common
Conflicts: kcm-plasmalogin
Provides:  kcm-plasmalogin
Requires: plasma-systemsettings%{?_isa}
Requires: polkit
Requires: qt6-filesystem

%description -n evernight-vista-logon-kcm
%{summary}.
...
%files -n evernight-vista-logon-kcm -f kcm_plasmalogin.lang
